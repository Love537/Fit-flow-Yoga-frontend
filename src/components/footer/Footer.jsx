            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-md">
                    <strong
                        ...
                        You want latest class Information, subscribe here?
                    </strong>
                    ...
                    <form className="mt-6">
                        <div className="relative max-w-lg">
                            ...
                            <button disabled
                                className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-secondary dark: px-5 py-3 text-sm font-medium text-white opacity-60" >
                                Subscribe
                            </button>
                        </div>
                    </form>
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        ...
                        <div className="mt-6 flex justify-center gap-4 lg:justify-start">
                            ...
                            {/*Maybe I can Add more like dribbles*/}
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <nav
                                ...
                                <Link className="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75" to="/HealthyDiet">
                                    Healthy Diet
                                </Link>
                                {/*<a className="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75" href="/">
                                    Healthy Diet
                            ...
                            </nav>   {/**  className="text-secondary cursor-not-allowed dark:text-white opacity-50 pointer-events-none"> */}
                        </div>
                        ...
                        <div>
                            ...
                            <nav aria-label="Footer About Nav" className="mt-6 flex flex-col space-y-1">
                                ...
                                <Link className="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75" to="/About">
                                    About
                                </Link>

                                <Link className="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75" to="/Instructors">
                                    Our Team
                                </Link>
                            </nav>
                        </div>
                        ...
                        <div>
                            ...
                            <nav
                                ...
                                className="mt-6 flex flex-col space-y-1">
                                <Link className="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75" to="/Contact">
                                    Contact
                                </Link>
                ...
                <div className="mt-16 border-t border-gray-100 pt-8">
                    <p className="text-center text-xs/relaxed text-gray-500">
                        ...
                        Created by &nbsp;
                        <a className="text-secondary dark: underline transition hover:text-secondary dark:/75">Lovepreet</a>
                    </p>
                </div>
            </div>
        </footer>
